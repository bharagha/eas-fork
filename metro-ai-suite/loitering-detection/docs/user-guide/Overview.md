...
[This sample application is ready for deployment with Edge Orchestrator. Download the deployment package and follow the instructions](https://docs.openedgeplatform.intel.com/loitering-detection/user-guide/how-to-deploy-with-edge-orchestrator.html)
